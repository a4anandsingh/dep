...
<div id="prjsetup_report">
  <table width="100%" border="0" cellpadding="3" class="ui-widget-content" cellspacing="1" style="margin-bottom:9px">
    ...
    <tr>
        ...
        <td align="left" class="ui-widget-content"><big><strong><?php echo $projectSetupValues['WORK_NAME_HINDI'];?></strong></big></td>
        <td align="left" class="ui-state-default"><strong> Project Sub Type</strong></td>
        <td align="left" class="ui-widget-content"><strong><?php echo $projectSetupValues['PROJECT_SUB_TYPE'];?></strong></td>
