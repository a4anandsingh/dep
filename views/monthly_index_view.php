...
<div id="content_wrapper">
    ...
    <div style="width:100%;float:left">
	     <?php  if($isValid) $message = '<big><big style="color:#f00">अभी आपकी कुछ परियोजना Setup या Financial and Physical Target Setup स्तर पर ही है इसलिए आप मासिक प्रविष्टी नहीं कर पा रहे हैं।</big></big>';
			echo getMessageBox('message', $message); ?>
    </div>
	<div style="width:100%;float:left;margin-bottom:5px" align="center">
    	<a target="_blank" href="<?php echo base_url();?>documents/help/deposit_monthly_entry_format.pdf" class="btn btn-primary">
