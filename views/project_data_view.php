<?php $projectSetupId = $projectSetupValues['PROJECT_SETUP_ID'];
...
<form name="frmProject" id="frmProject" onsubmit="return false;" enctype="multipart/form-data" autocomplete="off">
    ...
    <input type="hidden" name="PARENT_PROJECT_ID" id="PARENT_PROJECT_ID"
           value="<?php echo $arrProjectData['PARENT_PROJECT_ID']; ?>">
    <input type="hidden" name="saveMode" id="saveMode" value="<?php echo ($projectSetupId) ? 2 : 0; ?>">
    <input type="hidden" name="PROJECT_SETUP_MODE" id="saveMode" value="<?php echo $projectSetupFlag ?>">
    <table width="100%" border="0" cellpadding="3" class="ui-widget-content" cellspacing="1" style="margin-bottom:9px">
        ...
        <tr>
            ...
            <td class="ui-widget-content"><strong> Deposit </strong></td>
        </tr>
        <tr>
            <td width="120" align="left" nowrap="nowrap" class="ui-state-default"><strong>Deposit Project Code</strong>
            </td>
        ...
        <tr>
            ...
            <td colspan="3" align="left" class="ui-widget-content"><?php echo getRequiredSign(''); ?>
                <input name="WORK_NAME" placeholder="Work Name" id="WORK_NAME" type="text" maxlength="255"
                       style="width:95%"
                       value="<?php echo $projectSetupValues['WORK_NAME']; ?>" class="" onpaste="return false"/></td>
        </tr>
        <tr>
            <td align="left" class="ui-state-default"><strong>कार्य का नाम</strong></td>
            <td colspan="3" align="left" class="ui-widget-content"><?php echo getRequiredSign(''); ?>
                <input name="WORK_NAME_HINDI" id="WORK_NAME_HINDI" placeholder="कार्य का नाम" type="text"
                       style="width:95%" maxlength="255"
                       value="<?php echo $projectSetupValues['WORK_NAME_HINDI']; ?>" class=""
    ...
    <table width="100%" border="0" cellpadding="3" class="ui-widget-content" cellspacing="1">
        <tr>
            <td width="100%" valign="top" colspan="2">
                <table>
                    <tr>
                        <td class="ui-state-default"><?php echo getRequiredSign('right'); ?><strong>Select Deposit
                                Scheme:</strong></td>
                        <td nowrap="nowrap" class="ui-widget-content">
                            <select name="DEPOSIT_SCHEME_ID" id="DEPOSIT_SCHEME_ID" class=" chosen-select required"
                                    onchange="showHead('DEPOSIT_SCHEME_ID')">
                ...
                <table width="100%" cellpadding="3" cellspacing="1" class="ui-widget-content">
                    ...
                    <tr>
                        ...
                        <td class="ui-widget-content">
                            <select name="AA_AUTHORITY_ID" id="AA_AUTHORITY_ID" style="width:180px;"
                                    class=" chosen-select" onchange="showHideOtherAuth('AA_AUTHORITY_ID')">
                    ...
                    <tr>
                        ...
                        <td class="ui-widget-content">
                            ...
                            <!--   <input type="text" name="AA_SCAN_COPY1" id="AA_SCAN_COPY1"></label>

                                    <div class='file-loading'>
                                        <input id='AA_SCAN_COPY' name='AA_SCAN_COPY' type='file'  style="width: 99%;" required="required">

                                    </div>  -->
                            <?php
                            /* if($projectSetupValues['AA_USER_FILE_NAME']!='') {
     $AAfilePath= base_url().'dep_uploads/'.$projectSetupValues['AA_FILE_URL'];
     if (file_exists($AAfilePath)) {
        $AAfilePath= base_url().'dep_uploads/'.$projectSetupValues['AA_FILE_URL'];
     }
     else
        $AAfilePath='';
    ...
    $AAfilePath='';*/
                            ...
                            $filePath = FCPATH . 'dep_uploads' . DIRECTORY_SEPARATOR . $projectSetupValues['AA_FILE_URL'];
                            if ($projectSetupValues['AA_USER_FILE_NAME'] != '') {
                                if (file_exists($filePath)) { ?>
                                    <div id="aa_button_div">
                                        <label>File Name
                                            : <?php echo $projectSetupValues['AA_USER_FILE_NAME']; ?></label><br>
                                        <a class="fm-button ui-state-default ui-corner-all" onclick="viewPDF(1,this)"
                                           download="aa_raa_file_<?php echo $arrProjectData['PROJECT_NAME'] ?>"
                                           id="<?php echo base_url() . 'dep_uploads/' . $projectSetupValues['AA_FILE_URL'] ?>">
                                    ...
                                    <div id="aa_upload_div" style="display: none;">
                                        <input type="file" onchange="showSize('AA_SCAN_COPY')" id="AA_SCAN_COPY"
                                               name="AA_SCAN_COPY"/>
                                ...
                                <input type="file"
                                       ...
                                       id="AA_SCAN_COPY" name="AA_SCAN_COPY" accept="application/pdf"/>
                                <span style="color:#f00">(.pdf)</span>
                                <?php
                            }
                            ?>
            ...
            <td width="50%" valign="top">
                ...
                <table width="100%" cellpadding="3" cellspacing="1" class="ui-widget-content" <?php if ($arrRAAData['RAA_NO'] == '') echo 'style="display:none"'; ?>>
                    ...
                    <tr class="raa" <?php if ($arrRAAData['RAA_NO'] == '') echo 'style="display:none"'; ?>>
                        <!-- <td nowrap="nowrap" class="ui-state-default"></td> -->
                        <td class="ui-widget-content" colspan="2">
                            <div id="msg_raa_file"></div>
                            <label><?php echo getRequiredSign('right'); ?><strong>Scanned Copy :</strong>(PDF)</label>
                            <!--  <input type="text" name="RAA_SCAN_COPY1" id="RAA_SCAN_COPY1">
                                    <div class='file-loading'>
                                        <input id='RAA_SCAN_COPY' name='RAA_SCAN_COPY' type='file' style="width: 99%;"  >

                                    </div>  -->
                            <?php
                            /*if($arrRAAData['RAA_USER_FILE_NAME']!='') {
                     $RAAfilePath= base_url().'dep_uploads/'.$arrRAAData['RAA_FILE_URL'];
                     if (file_exists($RAAfilePath)) {
                        $RAAfilePath= base_url().'dep_uploads/'.$arrRAAData['RAA_FILE_URL'];
                     }
                     else
                        $RAAfilePath='';
                    ...
                    $RAAfilePath='';*/
                            ...
                            $filePath = FCPATH . 'dep_uploads' . DIRECTORY_SEPARATOR . $arrRAAData['RAA_FILE_URL'];
                            if ($arrRAAData['RAA_USER_FILE_NAME'] != '') {
                                if (file_exists($filePath)) { ?>
                                    <div id="raa_button_div">
                                        <label>File Name : <?php echo $arrRAAData['RAA_USER_FILE_NAME']; ?></label>
                                        <a class="fm-button ui-state-default ui-corner-all" onclick="viewPDF(2,this)"
                                           id="<?php echo base_url() . 'dep_uploads/' . $arrRAAData['RAA_FILE_URL'] ?>"> <span
                                    ...
                                    <div id="raa_upload_div" style="display: none;">
                                        <input type="file" onchange="showSize('RAA_SCAN_COPY')" id="RAA_SCAN_COPY"
                                               name="RAA_SCAN_COPY"/>
                                        <span style="color:#f00">(.pdf)</span>
                                    </div>
                                    <?php
        ...
        <span id="sp_arrow_frm1_up" style="display:none;"><i class="cus-arrow-up"></i></span>
            ...
            <div id="frm1" style="display:none;">
                <table width="100%" cellpadding="3" cellspacing="2" class="ui-widget-content">
                    <tr>
                        <td colspan="4" class="ui-widget-header"><strong>Benefitted details of Master Project:</strong>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td valign="top" class="ui-widget-content">
                            <input type="hidden" name="BLOCK_ID" id="BLOCK_ID"
                                   value="<?php echo $projectSetupValues['BLOCK_ID']; ?>"/>
                            <strong><?php echo $projectSetupValues['BLOCK_NAME']; ?></strong>
                            <!--   <select name="BLOCK_ID" id="BLOCK_ID" class="chosen-select " style="width:200px;">
                    ...
                    <tr>
                        ...
                        <td valign="top" class="ui-widget-content">
                            ...
                            <input type="hidden" name="ASSEMBLY_ID" id="ASSEMBLY_ID"
                                   value="<?php echo $projectSetupValues['ASSEMBLY_ID']; ?>"/>
                            <strong><?php echo $projectSetupValues['ASSEMBLY_NAME']; ?></strong>
    ...
    <?php echo $ASSEMBLY_CONST; ?>
                        ...
                        <td valign="top" class="ui-state-default"><?php echo getRequiredSign('right'); ?> <strong>Tehsil
                                (Site) :</strong></td>
                        <td valign="top" class="ui-widget-content">
                            <input type="hidden" name="TEHSIL_ID" id="TEHSIL_ID"
                                   value="<?php echo $projectSetupValues['TEHSIL_ID']; ?>"/>
                            <strong><?php echo $projectSetupValues['TEHSIL_NAME']; ?></strong>
                            <!--  <select name="TEHSIL_ID" id="TEHSIL_ID" class="chosen-select " style="width:200px;">
      <?php echo $TEHSIL_START; ?>
                    ...
                    <tr>
                        ...
                        <td class="ui-widget-content" valign="top" colspan="3">
                            <input type="text" name="NALLA_RIVER" id="NALLA_RIVER"
                                   onkeypress="return validateKeyStrokes(event)" title="Only Alphabets allowed"
                                   style="width:98%" value="<?php echo $projectSetupValues['NALLA_RIVER']; ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4" class="ui-widget-header"><strong>Benefitted details of this Project:</strong>
                        </td>
                    </tr>
                    <tr>
        ...
        //Conditional Load data view for MI/Tubewell/Default
        ...
        if($arrProjectData['PROJECT_SUB_TYPE_ID']==5){
            ...
            include_once('projects_default_data_view.php');
        }
        ?>
    ...
    <div id="mySaveDiv" align="right" class="mysavebar"><?php echo $buttons;
        ?></div>
</form>
<?php
if($arrProjectData['PROJECT_SUB_TYPE_ID']==5){
    ...
    include_once('projects_default_js.php');
}
?>
