...
<tr>
    <td colspan="5" nowrap="nowrap" class="ui-widget-content">
        ...
        //echo 'actual completion date ='. $ACTUAL_COMPLETION_DATE;
		switch($arrCurrentMonthData['WORK_STATUS']){
			case 5:
...
<tr>
    ...
    <tr>
      ...
      <td class="ui-widget-content" align="center" id="divCFY_L_EARTHWORK"><?php echo ($setupData['L_EARTHWORK_NA'])? 'NA':($arrCFY['L_EARTHWORK'] + $arrCurrentMonthData['L_EARTHWORK']);?></td>
      <td class="ui-widget-content" align="center"><?php echo ($setupData['L_EARTHWORK_NA'])? 'NA':$arrTLY['L_EARTHWORK'];?></td>
      <td class="ui-widget-content" align="center" id="divTOTAL_L_EARTHWORK"><?php echo ($setupData['L_EARTHWORK_NA'])? 'NA':($arrCFY['L_EARTHWORK'] + $arrCurrentMonthData['L_EARTHWORK']+$arrTLY['L_EARTHWORK']);?></td>
    </tr>
    ...
    <tr>
      ...
      <td class="ui-widget-content" align="center" id="divCFY_C_PIPEWORK"><?php echo ($setupData['C_PIPEWORK_NA'])? 'NA':($arrCFY['C_PIPEWORK'] + $arrCurrentMonthData['C_PIPEWORK']);?></td>
      <td class="ui-widget-content" align="center"><?php echo ($setupData['C_PIPEWORK_NA'])? 'NA':$arrTLY['C_PIPEWORK'];?></td>
      <td class="ui-widget-content" align="center" id="divTOTAL_C_PIPEWORK"><?php echo ($setupData['C_PIPEWORK_NA'])? 'NA':($arrCFY['C_PIPEWORK'] + $arrCurrentMonthData['C_PIPEWORK']+$arrTLY['C_PIPEWORK']);?></td>
    </tr>
    ...
    <tr>
      ...
      <td class="ui-widget-content" align="center" id="divCFY_C_DRIP_PIPE"><?php echo ($setupData['C_DRIP_PIPE_NA'])? 'NA':($arrCFY['C_DRIP_PIPE'] + $arrCurrentMonthData['C_DRIP_PIPE']);?></td>
      ...
      <td class="ui-widget-content" align="center" id="divTOTAL_C_DRIP_PIPE">
	  	<?php echo ($setupData['C_DRIP_PIPE_NA'])? 'NA':($arrCFY['C_DRIP_PIPE'] + $arrCurrentMonthData['C_DRIP_PIPE']+($arrCFY['C_DRIP_PIPE'] + $arrCurrentMonthData['C_DRIP_PIPE']+$arrTLY['C_DRIP_PIPE']));?>
      </td>
    </tr>
	<?php if($setupData['C_WATERPUMP_NA']==0){array_push($arrDataFields, 'C_WATERPUMP');}?>
      ...
      <?php 
        ...
        <td class="ui-widget-content" align="center" id="divCFY_C_WATERPUMP"><?php echo ($setupData['C_WATERPUMP_NA'])? 'NA':($arrCFY['C_WATERPUMP'] + $arrCurrentMonthData['C_WATERPUMP']);?></td>
        <td class="ui-widget-content" align="center"><?php echo ($setupData['C_WATERPUMP_NA'])? 'NA':$arrTLY['C_WATERPUMP'];?></td>
        <td class="ui-widget-content" align="center" id="divTOTAL_C_WATERPUMP"><?php echo ($setupData['C_WATERPUMP_NA'])? 'NA':($arrCFY['C_WATERPUMP'] + $arrCurrentMonthData['C_WATERPUMP']+$arrTLY['C_WATERPUMP']);?></td>                
    </tr>
