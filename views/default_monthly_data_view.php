...
<tr>
    ...
    <tr>
      ...
      <td class="ui-widget-content" align="center" id="divCFY_HW_EARTHWORK"><?php echo ($setupData['HW_EARTHWORK_NA'])? 'NA':(floatVal($arrCFY['HW_EARTHWORK']) + floatVal($arrCurrentMonthData['HW_EARTHWORK']));?></td>
      <td class="ui-widget-content" align="center"><?php echo ($setupData['HW_EARTHWORK_NA'])? 'NA':$arrTLY['HW_EARTHWORK'];?></td>
      <td class="ui-widget-content" align="center" id="divTOTAL_HW_EARTHWORK"><?php echo ($setupData['HW_EARTHWORK_NA'])? 'NA':(floatVal($arrCFY['HW_EARTHWORK']) + floatVal($arrCurrentMonthData['HW_EARTHWORK'])+floatVal($arrTLY['HW_EARTHWORK']));?></td>
    </tr>
	<?php    
    ...
    <tr>
        ...
        <td class="ui-widget-content" align="center" id="divCFY_HW_MASONRY"><?php echo ($setupData['HW_MASONRY_NA'])? 'NA':(floatVal($arrCFY['HW_MASONRY']) + floatVal($arrCurrentMonthData['HW_MASONRY']));?></td>
        <td class="ui-widget-content" align="center"><?php echo ($setupData['HW_MASONRY_NA'])? 'NA':$arrTLY['HW_MASONRY'];?></td>
        <td class="ui-widget-content" align="center" id="divTOTAL_HW_MASONRY"><?php echo ($setupData['HW_MASONRY_NA'])? 'NA':(floatVal($arrCFY['HW_MASONRY']) + floatVal($arrCurrentMonthData['HW_MASONRY'])+floatVal($arrTLY['HW_MASONRY']));?></td>
    </tr>            
	<?php 
    ...
    <tr>
      ...
      <td class="ui-widget-content" ><strong>MT</strong></td>
      ...
      <?php 
		...
		array_push($arrForValidation, "'STEEL_WORK':{required : true, number:true, min:0, checkMyDigit:'', max: $max_val}");
		array_push($arrForValidationMessage, "'STEEL_WORK':{required : 'आंकड़े प्रविष्ट करना अनिवार्य है...', number:'number', min:'Min Value 0', max: 'Max value $max_val'}");
		}?>
      </td>
      <td class="ui-widget-content" align="center"><?php echo ($setupData['STEEL_WORK_NA'])? 'NA':$arrPreviousMonthData['STEEL_WORK'];?></td>
      <td class="ui-widget-content" align="center" id="divCFY_STEEL_WORK"><?php echo ($setupData['STEEL_WORK_NA'])? 'NA':(floatVal($arrCFY['STEEL_WORK']) + floatVal($arrCurrentMonthData['STEEL_WORK']));?></td>
      <td class="ui-widget-content" align="center"><?php echo ($setupData['STEEL_WORK_NA'])? 'NA':$arrTLY['STEEL_WORK'];?></td>
      <td class="ui-widget-content" align="center" id="divTOTAL_STEEL_WORK"><?php echo ($setupData['STEEL_WORK_NA'])? 'NA':(floatVal($arrCFY['STEEL_WORK']) + floatVal($arrCurrentMonthData['STEEL_WORK'])+floatVal($arrTLY['STEEL_WORK']));?></td>
    </tr>
	<?php    
    ...
    <tr>
      ...
      <?php 
		...
		array_push($arrForValidation, "'CANAL_EARTHWORK':{required : true,number:true, min:0, checkMyDigit:'', max: $max_val}");
		array_push($arrForValidationMessage, "'CANAL_EARTHWORK':{required : 'आंकड़े प्रविष्ट करना अनिवार्य है...', number:'number', min:'Min Value 0', max: 'Max value $max_val'}");
		}?>
      </td>
      <td class="ui-widget-content" align="center"><?php echo ($setupData['CANAL_EARTHWORK_NA'])? 'NA':$arrPreviousMonthData['CANAL_EARTHWORK'];?></td>
      <td class="ui-widget-content" align="center" id="divCFY_CANAL_EARTHWORK"><?php echo ($setupData['CANAL_EARTHWORK_NA'])? 'NA':(floatVal($arrCFY['CANAL_EARTHWORK']) + floatVal($arrCurrentMonthData['CANAL_EARTHWORK']));?></td>
      ...
      <td class="ui-widget-content" align="center" id="divTOTAL_CANAL_EARTHWORK">
	  	<?php echo ($setupData['CANAL_EARTHWORK_NA'])? 'NA':(floatVal($arrCFY['CANAL_EARTHWORK']) + floatVal($arrCurrentMonthData['CANAL_EARTHWORK'])+(floatVal($arrCFY['CANAL_EARTHWORK']) + floatVal($arrCurrentMonthData['CANAL_EARTHWORK'])+floatVal($arrTLY['CANAL_EARTHWORK'])));?>
      </td>
    </tr>
	<?php 
   if($setupData['CANAL_STRUCTURE_NA']==0){array_push($arrDataFields, 'CANAL_STRUCTURE');}?>
      ...
      <?php 
        ...
        <td class="ui-widget-content" align="center" id="divCFY_CANAL_STRUCTURE"><?php echo ($setupData['CANAL_STRUCTURE_NA'])? 'NA':(intVal($arrCFY['CANAL_STRUCTURE']) + intVal($arrCurrentMonthData['CANAL_STRUCTURE']));?></td>
        <td class="ui-widget-content" align="center"><?php echo ($setupData['CANAL_STRUCTURE_NA'])? 'NA':$arrTLY['CANAL_STRUCTURE'];?></td>
        <td class="ui-widget-content" align="center" id="divTOTAL_CANAL_STRUCTURE"><?php echo ($setupData['CANAL_STRUCTURE_NA'])? 'NA':(intVal($arrCFY['CANAL_STRUCTURE']) + intVal($arrCurrentMonthData['CANAL_STRUCTURE'])+intVal($arrTLY['CANAL_STRUCTURE']));?></td>                
    </tr>
      ...
      <?php 
		...
		array_push($arrForValidation, "'CANAL_STRUCTURE_MASONRY':{required : true, number:true, min:0, checkMyDigit:'', max: $max_val}");
		array_push($arrForValidationMessage, "'CANAL_STRUCTURE_MASONRY':{required : 'आंकड़े प्रविष्ट करना अनिवार्य है...', number:'number', min:'Min Value 0', max: 'Max value $max_val'}");
		}?>
      </td>
      ...
      <td class="ui-widget-content" align="center" id="divCFY_CANAL_STRUCTURE_MASONRY"><?php echo ($setupData['CANAL_STRUCTURE_MASONRY_NA'])? 'NA':(floatVal($arrCFY['CANAL_STRUCTURE_MASONRY']) + floatVal($arrCurrentMonthData['CANAL_STRUCTURE_MASONRY']));?></td>
      ...
      <td class="ui-widget-content" align="center" id="divTOTAL_CANAL_STRUCTURE_MASONRY"><?php echo ($setupData['CANAL_STRUCTURE_MASONRY_NA'])? 'NA':(floatVal($arrCFY['CANAL_STRUCTURE_MASONRY']) + floatVal($arrCurrentMonthData['CANAL_STRUCTURE_MASONRY'])+floatVal($arrTLY['CANAL_STRUCTURE_MASONRY']));?></td>
    </tr>
      ...
      <td class="ui-widget-content" ><strong>KM</strong></td>
      ...
      <?php 
        ...
        array_push($arrMonthlyData, "'CANAL_LINING':{'ESTI':".(($arrEstimationData['CANAL_LINING'])?$arrEstimationData['CANAL_LINING']:0).", 'CFY':".$arrCFY['CANAL_LINING'].", 'TLY':".$arrTLY['CANAL_LINING']."}");
         ...
         $max_val=floatVal($esti)-(floatVal($arrCFY['CANAL_LINING']) + floatVal($arrTLY['CANAL_LINING'])); 
        array_push($arrForValidation, "'CANAL_LINING':{required : true, number:true, min:0, checkMyDigit:'', max: $max_val}");
        array_push($arrForValidationMessage, "'CANAL_LINING':{required : 'आंकड़े प्रविष्ट करना अनिवार्य है...', number:'number', min:'Min Value 0', max: 'Max value $max_val'}");
        }?>
      </td>
      <td class="ui-widget-content" align="center"><?php echo ($setupData['CANAL_LINING_NA'])? 'NA':$arrPreviousMonthData['CANAL_LINING'];?></td>
      <td class="ui-widget-content" align="center" id="divCFY_CANAL_LINING"><?php echo ($setupData['CANAL_LINING_NA'])? 'NA':(floatVal($arrCFY['CANAL_LINING']) + floatVal($arrCurrentMonthData['CANAL_LINING']));?></td>
      <td class="ui-widget-content" align="center"><?php echo ($setupData['CANAL_LINING_NA'])? 'NA':$arrTLY['CANAL_LINING'];?></td>
      <td class="ui-widget-content" align="center" id="divTOTAL_CANAL_LINING"><?php echo ($setupData['CANAL_LINING_NA'])? 'NA':(floatVal($arrCFY['CANAL_LINING']) + floatVal($arrCurrentMonthData['CANAL_LINING'])+floatVal($arrTLY['CANAL_LINING']));?></td>
    </tr>
...
$s = $k.": {
		...
		$arrTotal['KHARIF']['ESTIMATION']+= intVal($v['ESTIMATION_IP']['KHARIF']);
		$arrTotal['KHARIF']['CURRENT_MONTH']+= intVal($v['CUR_MONTH_IP']['KHARIF']);
		$arrTotal['KHARIF']['PREV_MONTH']+= intVal($v['PREV_MONTH_IP']['KHARIF']);
		$arrTotal['KHARIF']['CFY']+= intVal($v['ACHIEVEMENT_IP_CFY']['KHARIF']);
		$arrTotal['KHARIF']['TLY']+= intVal($v['ACHIEVEMENT_IP_TLY']['KHARIF']);
		$arrTotal['KHARIF']['TOTAL']+= (intVal($v['ACHIEVEMENT_IP_CFY']['KHARIF'])+intVal($v['ACHIEVEMENT_IP_TLY']['KHARIF']));

          $arrTotal['RABI']['ESTIMATION']+= intVal($v['ESTIMATION_IP']['RABI']);
          $arrTotal['RABI']['CURRENT_MONTH']+= intVal($v['CUR_MONTH_IP']['RABI']);
          $arrTotal['RABI']['PREV_MONTH']+= intVal($v['PREV_MONTH_IP']['RABI']);
          $arrTotal['RABI']['CFY']+= intVal($v['ACHIEVEMENT_IP_CFY']['RABI']);
          $arrTotal['RABI']['TLY']+= intVal($v['ACHIEVEMENT_IP_TLY']['RABI']);
          $arrTotal['RABI']['TOTAL']+= (intVal($v['ACHIEVEMENT_IP_CFY']['RABI'])+intVal($v['ACHIEVEMENT_IP_TLY']['RABI']));

          $arrTotal['TOTAL']['ESTIMATION']+= intVal($v['ESTIMATION_IP']['IP']);
          $arrTotal['TOTAL']['CURRENT_MONTH']+= intVal($v['CUR_MONTH_IP']['IP']);
          $arrTotal['TOTAL']['PREV_MONTH']+= intVal($v['PREV_MONTH_IP']['IP']);
          $arrTotal['TOTAL']['CFY']+= intVal($v['ACHIEVEMENT_IP_CFY']['IP']);
          $arrTotal['TOTAL']['TLY']+= intVal($v['ACHIEVEMENT_IP_TLY']['IP']);
...
//RABI
        ...
        $arrTotal['KHARIF_RESTORED']['ESTIMATION']+= intval($v['ESTIMATION_IP']['KHARIF_RESTORED']);
        $arrTotal['KHARIF_RESTORED']['CURRENT_MONTH']+= intval($v['CUR_MONTH_IP']['KHARIF_RESTORED']);
        $arrTotal['KHARIF_RESTORED']['PREV_MONTH']+= intval($v['PREV_MONTH_IP']['KHARIF_RESTORED']);
        $arrTotal['KHARIF_RESTORED']['CFY']+= intval($v['ACHIEVEMENT_IP_CFY']['KHARIF_RESTORED']);
        $arrTotal['KHARIF_RESTORED']['TLY']+= intval($v['ACHIEVEMENT_IP_TLY']['KHARIF_RESTORED']);
        $arrTotal['KHARIF_RESTORED']['TOTAL']+= (intval($v['ACHIEVEMENT_IP_CFY']['KHARIF_RESTORED'])+intval($v['ACHIEVEMENT_IP_TLY']['KHARIF_RESTORED']));

          $arrTotal['RABI_RESTORED']['ESTIMATION']+= intval($v['ESTIMATION_IP']['RABI_RESTORED']);
          $arrTotal['RABI_RESTORED']['CURRENT_MONTH']+= intval($v['CUR_MONTH_IP']['RABI_RESTORED']);
          $arrTotal['RABI_RESTORED']['PREV_MONTH']+= intval($v['PREV_MONTH_IP']['RABI_RESTORED']);
          $arrTotal['RABI_RESTORED']['CFY']+= intval($v['ACHIEVEMENT_IP_CFY']['RABI_RESTORED']);
          $arrTotal['RABI_RESTORED']['TLY']+= intval($v['ACHIEVEMENT_IP_TLY']['RABI_RESTORED']);
          $arrTotal['RABI_RESTORED']['TOTAL']+= (intval($v['ACHIEVEMENT_IP_CFY']['RABI_RESTORED'])+intval($v['ACHIEVEMENT_IP_TLY']['RABI_RESTORED']));

          $arrTotal['TOTAL']['ESTIMATION']+= intval($v['ESTIMATION_IP']['RESTORED_IP']);
          $arrTotal['TOTAL']['CURRENT_MONTH']+= intval($v['CUR_MONTH_IP']['RESTORED_IP']);
          $arrTotal['TOTAL']['PREV_MONTH']+= intval($v['PREV_MONTH_IP']['RESTORED_IP']); 
          $arrTotal['TOTAL']['CFY']+= intval($v['ACHIEVEMENT_IP_CFY']['RESTORED_IP']);
          $arrTotal['TOTAL']['TLY']+= intval($v['ACHIEVEMENT_IP_TLY']['RESTORED_IP']);
          $arrTotal['TOTAL']['TOTAL']+= (intval($v['ACHIEVEMENT_IP_CFY']['RESTORED_IP'])+intval($v['ACHIEVEMENT_IP_TLY']['RESTORED_IP']));
  ...
  <?php } ?>
    <tr>
      <td class="ui-state-default" colspan="4" rowspan="3">Total Irrigation Potential Restored</td>
      <td><strong>Kharif</strong></td>
...
<tr>
    ...
    <td class="ui-widget-content" align="center">
        ...
        <textarea id="CANAL_LINING_STATUS_REMARK" name="CANAL_LINING_STATUS_REMARK" cols="35" 
...
function calculateSubRestoredIrri(blockId111){
    ...
    for(i=0;i<arrB.length;i++){
        ...
        var totalcfyBr = intval(cfyBr) + intval(curMonthBr);
        var totaltlyBr = tintval(otalcfyBr) + intval(tlyBr);
            if(totaltlyBr>rr)
           {
