...
<tr>
    ...
    <tr>
      ...
      <td class="ui-widget-content" align="center">
       <?php 
		...
		<?php
		array_push($arrMonthlyData, "'LA_COMPLETED_HA':{'ESTI':".$arrEstimationData['LA_HA'].", 'CFY':".$arrCFY['LA_HA'].", 'TLY':".$arrTLY['LA_HA']."}");
          $esti= $arrEstimationData['LA_HA'];
    $max_val=$esti-($arrCFY['LA_HA'] + $arrTLY['LA_HA']);
    ...
    <tr>
      ...
      <?php 
        ...
        <?php 
		array_push($arrMonthlyData, "'FA_COMPLETED_HA':{'ESTI':".$arrEstimationData['FA_HA'].", 'CFY':".$arrCFY['FA_COMPLETED_HA'].", 'TLY':".$arrTLY['FA_COMPLETED_HA']."}");
         $esti= $arrEstimationData['FA_HA'];
      ...
      <?php 
		...
		<?php 
         ...
         $max_val=$esti-($arrCFY['HW_EARTHWORK'] + $arrTLY['HW_EARTHWORK']);
			...
			array_push($arrMonthlyData, "'HW_EARTHWORK':{'ESTI':".$arrEstimationData['HW_EARTHWORK'].", 'CFY':".$arrCFY['HW_EARTHWORK'].", 'TLY':".$arrTLY['HW_EARTHWORK']."}");
    ...
    <tr>
		...
		if($setupData['HW_MASONRY_NA']){
         ...
         $max_val=$esti-($arrCFY['HW_MASONRY'] + $arrTLY['HW_MASONRY']);          
			array_push($arrMonthlyData, "'HW_MASONRY':{'ESTI':".$arrEstimationData['HW_MASONRY'].", 'CFY':".$arrCFY['HW_MASONRY'].", 'TLY':".$arrTLY['HW_MASONRY']."}");
    ...
    <tr>
      ...
      <?php 
		...
		<?php 
		array_push($arrMonthlyData, "'STEEL_WORK':{'ESTI':".$arrEstimationData['STEEL_WORK'].", 'CFY':".$arrCFY['STEEL_WORK'].", 'TLY':".$arrTLY['STEEL_WORK']."}");
    ...
    <tr>
      ...
      <?php 
		...
		<?php 
		array_push($arrMonthlyData, "'CANAL_EARTHWORK':{'ESTI':".$arrEstimationData['CANAL_EARTHWORK'].", 'CFY':".$arrCFY['CANAL_EARTHWORK'].", 'TLY':".$arrTLY['CANAL_EARTHWORK']."}");
   ...
   if($setupData['CANAL_STRUCTURE_NA']==0){array_push($arrDataFields, 'CANAL_STRUCTURE');}?>
      ...
      <?php 
		...
		<?php 
		array_push($arrMonthlyData, "'CANAL_STRUCTURE':{'ESTI':".$arrEstimationData['CANAL_STRUCTURE'].", 'CFY':".$arrCFY['CANAL_STRUCTURE'].", 'TLY':".$arrTLY['CANAL_STRUCTURE']."}");
      ...
      <?php 
		...
		<?php 
		array_push($arrMonthlyData, "'CANAL_STRUCTURE_MASONRY':{'ESTI':".$arrEstimationData['CANAL_STRUCTURE_MASONRY'].", 'CFY':".$arrCFY['CANAL_STRUCTURE_MASONRY'].", 'TLY':".$arrTLY['CANAL_STRUCTURE_MASONRY']."}");
      ...
      <?php 
        ...
        <?php 
        array_push($arrMonthlyData, "'CANAL_LINING':{'ESTI':".$arrEstimationData['CANAL_LINING'].", 'CFY':".$arrCFY['CANAL_LINING'].", 'TLY':".$arrTLY['CANAL_LINING']."}");
...
$s = $k.": {
            'KHARIF_RESTORED':{'ESTI':".$v['ESTIMATION_IP']['KHARIF_RESTORED'].", 'CFY':".$v['ACHIEVEMENT_IP_CFY']['KHARIF_RESTORED'].", 'TLY':".$v['ACHIEVEMENT_IP_TLY']['KHARIF_RESTORED']."}, 
            'RABI_RESTORED':{'ESTI':".$v['ESTIMATION_IP']['KHARIF_RESTORED'].", 'CFY':".$v['ACHIEVEMENT_IP_CFY']['RABI_RESTORED'].", 'TLY':".$v['ACHIEVEMENT_IP_TLY']['RABI_RESTORED']."}, 
            'TOTAL':{'ESTI':".$v['ESTIMATION_IP']['KHARIF_RESTORED'].", 'CFY':".$v['ACHIEVEMENT_IP_CFY']['IP'].", 'TLY':".$v['ACHIEVEMENT_IP_TLY']['IP']."} 
            }";
//RABI
