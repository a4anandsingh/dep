...
$arrSetupData['IRRIGATION_POTENTIAL_TO_BE_RESTORED_NA'] = $arrSetupData['IP_TOTAL_NA'];
?>
            ...
            <div style="width:100%;float:left;padding:5px" id="yearlyformdata">
              <table width="100%" border="0" cellpadding="2" cellspacing="1" class="ui-widget-content" style="margin-bottom:5px">
                ...
                <tr>
                    ...
                    exit;*/
                    //showArrayValues($arrTargetBlockData);
                    //showArrayValues($arrAchievement);
                                                ...
                                                foreach($arrBlockIps as $k=>$v) {
                                                    ...
                                                    if(!$arrSetupData['IRRIGATION_POTENTIAL_TO_BE_RESTORED_NA'])
                                                    {
                                                        echo '    <input name="IP_RESTORED' . '[' . $arrColumn['MONTH'] . ']['.$k.']"
                                                            ...
                                                            value="' . ($arrTargetBlockData[$arrColumn['TARGET_DATE']][$k]['KHARIF_RESTORED'] + $arrTargetBlockData[$arrColumn['TARGET_DATE']][$k]['RABI_RESTORED']) . '" type="text" maxlength="10"  
                                                            size="' . $arrColumn['COL_WIDTH'] . '" class="centertext xtext myytclass in_ip"
                                                            autocomplete="off" 
                                                               readonly="readonly" style="background-color:#ECF9FF"  />';
                                                    }
                                                    $subTotalKharifRestored += $arrTargetBlockData[$arrColumn['TARGET_DATE']][$k]['KHARIF_RESTORED'];
                                                    $subTOtalRabiRestored += $arrTargetBlockData[$arrColumn['TARGET_DATE']][$k]['RABI_RESTORED'];
                                                    //$subTotalIp += $arrTargetBlockData[$arrColumn['TARGET_DATE']][$k]->IP_TOTAL ;
                                                    $subTotalIpRestored += ($arrTargetBlockData[$arrColumn['TARGET_DATE']][$k]['KHARIF_RESTORED']+ $arrTargetBlockData[$arrColumn['TARGET_DATE']][$k]['RABI_RESTORED']);
                  ...
                  <td align="center" class="ui-state-default" id="TOTAL_T">&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td align="center" class="ui-widget-content" id="TOTAL_ESTI"><?php echo ($arrEstimation['KHARIF']+$arrEstimation['RABI']);?></td>
                  ...
                  <tr>
                      ...
                      <td align="center" class="ui-widget-content" id="C_MASONRY_ACHIEVE"><?php echo ($arrSetupData['C_MASONRY_NA'])?'':
                              $arrAchievement['C_MASONRY'];?></td>
                      ...
                      <td align="center" class="ui-widget-content" id="TOTAL_ACHIEVE"><?php echo ($arrAchievement['KHARIF']+$arrAchievement['RABI']);?></td>
                    ...
                    <tr>
                        <td colspan="20" align="left" class="ui-widget-content">
