...
<tr>
    ...
    <tr>
      ...
      <td align="center" class="ui-widget-content" id="divCFY_L_EARTHWORK"><?php echo ($setupData['L_EARTHWORK_NA'])? 'NA':($arrCFY['L_EARTHWORK'] + $arrCurrentMonthData['L_EARTHWORK']);?></td>
      <td align="center" class="ui-widget-content"><?php echo ($setupData['L_EARTHWORK_NA'])? 'NA':$arrTLY['L_EARTHWORK'];?></td>
      <td align="center" class="ui-widget-content" id="divTOTAL_L_EARTHWORK"><?php echo ($setupData['L_EARTHWORK_NA'])? 'NA':($arrCFY['L_EARTHWORK'] + $arrCurrentMonthData['L_EARTHWORK']+$arrTLY['L_EARTHWORK']);?></td>
    </tr>
    <tr>
      ...
      <td align="center" class="ui-widget-content" id="divCFY_DRILLINGWORK"><?php echo ($setupData['DRILLINGWORK_NA'])? 'NA':($arrCFY['DRILLINGWORK'] + $arrCurrentMonthData['DRILLINGWORK']);?></td>
      <td align="center" class="ui-widget-content"><?php echo ($setupData['DRILLINGWORK_NA'])? 'NA':$arrTLY['DRILLINGWORK'];?></td>
      <td align="center" class="ui-widget-content" id="divTOTAL_DRILLINGWORK"><?php echo ($setupData['DRILLINGWORK_NA'])? 'NA':($arrCFY['DRILLINGWORK'] + $arrCurrentMonthData['DRILLINGWORK']+$arrTLY['DRILLINGWORK']);?></td>
    </tr>
    ...
    <tr>
		...
		if($setupData['C_MASONRY_NA']){
            ...
            <?php
            //showArrayValues($arrEstimationData);
			array_push($arrMonthlyData,
                "'C_MASONRY':{'ESTI':".$arrEstimationData['C_MASONRY'].", 
			'CFY':".$arrCFY['C_MASONRY'].", 
			'TLY':".$arrTLY['C_MASONRY']."}");
        ...
        <td class="ui-widget-content" align="center" id="divCFY_C_MASONRY"><?php echo ($setupData['C_MASONRY_NA'])? 'NA':($arrCFY['C_MASONRY'] + $arrCurrentMonthData['C_MASONRY']);?></td>
        <td class="ui-widget-content" align="center"><?php echo ($setupData['C_MASONRY_NA'])? 'NA':$arrTLY['C_MASONRY'];?></td>
        <td class="ui-widget-content" align="center" id="divTOTAL_C_MASONRY"><?php echo ($setupData['C_MASONRY_NA'])? 'NA':($arrCFY['C_MASONRY'] + $arrCurrentMonthData['C_MASONRY']+$arrTLY['C_MASONRY']);?></td>
    </tr>            
    ...
    <tr>
      ...
      <td class="ui-widget-content" align="center" id="divCFY_HOUSING_PIPE"><?php echo ($setupData['HOUSING_PIPE_NA'])? 'NA':($arrCFY['HOUSING_PIPE'] + $arrCurrentMonthData['HOUSING_PIPE']);?></td>
      <td class="ui-widget-content" align="center"><?php echo ($setupData['HOUSING_PIPE_NA'])? 'NA':$arrTLY['HOUSING_PIPE'];?></td>
      <td class="ui-widget-content" align="center" id="divTOTAL_HOUSING_PIPE"><?php echo ($setupData['HOUSING_PIPE_NA'])? 'NA':($arrCFY['HOUSING_PIPE'] + $arrCurrentMonthData['HOUSING_PIPE']+$arrTLY['HOUSING_PIPE']);?></td>
    </tr>
    ...
    <tr>
      ...
      <td class="ui-widget-content" align="center" id="divCFY_BLIND_PIPE"><?php echo ($setupData['BLIND_PIPE_NA'])? 'NA':($arrCFY['BLIND_PIPE'] + $arrCurrentMonthData['BLIND_PIPE']);?></td>
      ...
      <td class="ui-widget-content" align="center" id="divTOTAL_BLIND_PIPE">
	  	<?php echo ($setupData['BLIND_PIPE_NA'])? 'NA':($arrCFY['BLIND_PIPE'] + $arrCurrentMonthData['BLIND_PIPE']
		+$arrTLY['BLIND_PIPE']);?>
      </td>
    </tr>
	<?php if($setupData['SLOTTED_PIPE_NA']==0){array_push($arrDataFields, 'SLOTTED_PIPE');}?>
      <tr>
        ...
        <td class="ui-widget-content" align="center" id="divCFY_SLOTTED_PIPE"><?php echo ($setupData['SLOTTED_PIPE_NA'])? 'NA':($arrCFY['SLOTTED_PIPE'] + $arrCurrentMonthData['SLOTTED_PIPE']);?></td>
		...
		<?php echo ($setupData['SLOTTED_PIPE_NA'])? 'NA':($arrCFY['SLOTTED_PIPE']+$arrTLY['SLOTTED_PIPE'] + $arrCurrentMonthData['SLOTTED_PIPE']);?></td>
      </tr>
      <tr>
      ...
      <?php 
        ...
        <td class="ui-widget-content" align="center" id="divCFY_SUBMERSIBLE"><?php echo ($setupData['SUBMERSIBLE_NA'])? 'NA':($arrCFY['SUBMERSIBLE'] + $arrCurrentMonthData['SUBMERSIBLE']);?></td>
        <td class="ui-widget-content" align="center"><?php echo ($setupData['SUBMERSIBLE_NA'])? 'NA':$arrTLY['SUBMERSIBLE'];?></td>
        <td class="ui-widget-content" align="center" id="divTOTAL_SUBMERSIBLE"><?php echo ($setupData['SUBMERSIBLE_NA'])? 'NA':($arrCFY['SUBMERSIBLE'] + $arrCurrentMonthData['SUBMERSIBLE']+$arrTLY['SUBMERSIBLE']);?></td>                
    </tr>
      ...
      <td class="ui-widget-content" align="center" id="divCFY_K_CONTROL_ROOMS"><?php echo ($setupData['K_CONTROL_ROOMS_NA'])? 'NA':($arrCFY['K_CONTROL_ROOMS'] + $arrCurrentMonthData['K_CONTROL_ROOMS']);?></td>
      <td class="ui-widget-content" align="center"><?php echo ($setupData['K_CONTROL_ROOMS_NA'])? 'NA':$arrTLY['K_CONTROL_ROOMS'];?></td>
      <td class="ui-widget-content" align="center" id="divTOTAL_K_CONTROL_ROOMS"><?php echo ($setupData['K_CONTROL_ROOMS_NA'])? 'NA':($arrCFY['K_CONTROL_ROOMS'] + $arrCurrentMonthData['K_CONTROL_ROOMS']+$arrTLY['K_CONTROL_ROOMS']);?></td>
    </tr>
      <tr>
...
<?php
//showArrayValues($arrMonthlyData);exit;
?>
...
function calculateSubRestoredIrri(blockId111){
    //console.log(arrMonthlyRestoreBlockData);
